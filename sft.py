...
data_config = {}
data_config["path"] = "/home/liao.629/rl-prompt-lzy/examples/text-style-transfer/attack_data/harmful_behavior_controls.json"
d = {}
d["train"] = 7
d["test"] = 3
data_config["ratio"] = d
data_config["keys"] = ["goal","controls"]
...
@dataclass
class DataArguments:
    data_path: str = field(default="/home/liao.629/rl-prompt-lzy/examples/text-style-transfer/attack_data/harmful_behavior_controls.json", metadata={"help": "Path to the training data."})
    train_data_ratio: float = field(default=1.0)
